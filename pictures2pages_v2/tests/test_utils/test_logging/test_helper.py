...
from pictures2pages_v2.app.utils.logging import status_code_colors, get_request_msg_args
...
@mock.patch("pictures2pages_v2.app.utils.logging.click.style", side_effect=click.style)
