...
import click
import logging
from pictures2pages_v2.app.utils.logging import ColorFormatter, request_msg_format
...
class TestColorFormatter:
    ...
    @mock.patch(
        "pictures2pages_v2.app.utils.logging.click.style", side_effect=click.style
    )
    ...
    @mock.patch("pictures2pages_v2.app.utils.logging.logging.Formatter")
