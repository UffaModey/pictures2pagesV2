...
from pictures2pages_v2.app.configs.base import Settings
from pictures2pages_v2.app.configs import get_settings
...
def test_assemble_cors_origins_success(cors_origins, expected_result):
    s = Settings(
        CORS_ORIGINS=cors_origins, CORS_ORIGIN_REGEX="https:\\/\\/.*\\.example\\.?"
    )
